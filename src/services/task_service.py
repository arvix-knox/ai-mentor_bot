...
class TaskService:
    ...
    async def create_task(
        ...
        return {"task_id": task.id, "title": task.title, "priority": task.priority, "deadline": task.deadline, "tags": task.tags}
    ...
    async def complete_task(self, user_id: int, task_id: int) -> dict:
        ...
        return {"title": task.title, "xp_earned": xp_amount + bonus, "leveled_up": leveled_up, "new_level": new_level}
